...
public class App {
    ...
    public static void findCats(ArrayList<Panthera> p) {
    ...
    public static void deletingCat(ArrayList<Panthera> p) {
    ...
    public static void riskReport(ArrayList<Panthera> p) {
        boolean locater = false;
    ...
    public static void warningReport(ArrayList<Panthera> p) {
        try {
